    ...
    <div className="flex justify-center items-center h-full flex-col">
      <div className="bg-slate-900 w-11/12 my-16 rounded-xl">
        <div className="flex justify-between items-center mx-10 my-7 sm:flex-col">
          ...
          <Link to="/add-admin">
            <button className="px-3 py-2 bg-violet-800 rounded-sm text-lg font-semibold">
              Adicionar Administrador
            </button>
          </Link>
        </div>
        <div className=" my-5 mx-10 py-6 border-t-2 border-indigo-500">
          ...
          {!isLoading && admin?.length === 0 ? (
            <p className="p-4 text-center">
              Nenhum administrador cadastrado. Por favor, adicione um administrador!
            </p>
          ) : (
            <table className="bg-slate-950/75 w-full rounded my-6">
              <thead>

    ...
    <>
      ...
      <div className="flex justify-center items-center">
        ...
        <div className={styles.content}>
          <div className="flex justify-between items-center mb-3 sm:flex-col">
            <h2 className="text-2xl font-semibold">
              Bem-vindo ao{" "}
              <span className="text-violet-600 font-bold">Guichê</span>
            </h2>
            <Link to="/add-balance">
              <button className="px-3 py-2 bg-violet-800 rounded-sm text-lg font-medium hover:bg-violet-700 transition-colors duration-300 sm:my-4 sm:w-full">
                Fazer Recarga
              </button>
            </Link>
          </div>

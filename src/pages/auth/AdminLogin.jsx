...
import { SET_LOGIN, SET_NAME } from "../../redux/features/Admin/Auth/AuthAdminSlice";
import Loader from "../../components/loader/Loader";
import { getAdmin } from "../../redux/features/Admin/Actions/AdminSlice";
import { loginAdmin, validateAdminEmail } from "../../services/authAdminService";
    ...
    <div className={`${styles.auth}`}>
      ...
      <Card>
        <div className={styles.form}>
          <h2> Entre em sua Conta <br /> Administradora </h2>
